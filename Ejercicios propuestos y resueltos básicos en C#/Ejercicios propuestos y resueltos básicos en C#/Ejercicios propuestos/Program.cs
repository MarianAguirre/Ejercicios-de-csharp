...
namespace Ejercicios.Propuestos
{
  class Ejercicios
  {
    ...
    {
      string nombre = Helper.ValidarHelper.PedirTexto("Por favor ingresa un nombre...");
      string ciudad = Helper.ValidarHelper.PedirTexto("Ahora escriba el nombre de una ciudad...");
    ...
    void Ejercicio3()
    {
      int edad = Helper.ValidarHelper.PedirEntero("Ingresa tu edad...");
    ...
    void Ejercicio4()
    {
      ...
      int numero1 = Helper.ValidarHelper.PedirEntero("Ingresa un numero...");
      int numero2 = Helper.ValidarHelper.PedirEntero("Ingresa un segundo numero...");
      if (numero1 > numero2)
      {
    ...
    void Ejercicio5()
    {
      ...
      string dia = Helper.ValidarHelper.PedirTexto("Escribe el nombre del día...");
    ...
    void Ejercicio6()
    {
      double precio = Helper.ValidarHelper.PedirDouble("Escribe el precio del producto...", 0.01);
      int formaPago = Helper.ValidarHelper.PedirEntero(@"Elige la forma de pago:
1) Efectivo
2) Tarjeta
", 1, 2);
      ...
      if (formaPago == 2)
      {
        string cuenta = Helper.ValidarHelper.PedirTexto("Ingrese el numero de cuenta...");
    ...
    public static void Main(string[] args)
    {
      ...
      do
      {
        ...
        Console.WriteLine("");
        opcion = Helper.ValidarHelper.PedirTexto("Elige un numero para ver el ejercicio...");
        Console.WriteLine("=================================");
        switch (opcion)
        {
          case "1":
